...
class LojaApp:
    def __init__(self, root):
        ...
        self.products = [
            ...
            {"name": "Camiseta Jesus & Cruz", "price": "R$ 69,99", "original_price": "R$ 69,99", "discount": "15% OFF", "image": "img/img3.jpg"},
            {"name": "Camiseta Coração Roxo", "price": "R$ 49,99", "original_price": "R$ 49,99", "discount": "19% OFF", "image": "img/img4.jpg"},
            {"name": "Camiseta Santo Espírito", "price": "R$ 79,99", "original_price": "R$ 79,99", "discount": "10% OFF", "image": "img/img5.jpg"},
            {"name": "Camiseta Coração Puro", "price": "R$ 89,99", "original_price": "R$ 89,99", "discount": "15% OFF", "image": "img/img6.jpg"},
            {"name": "Camiseta Jesus Morreu Por Mim", "price": "R$ 59,99", "original_price": "R$ 59,99", "discount": "25% OFF", "image": "img/img7.jpg"},
            {"name": "Camiseta Branca Jesus", "price": "R$ 99,99", "original_price": "R$ 99,99", "discount": "30% OFF", "image": "img/img8.jpg"},
            {"name": "Camiseta Servir Jesus", "price": "R$ 49,99", "original_price": "R$ 49,99", "discount": "5% OFF", "image": "img/img9.png"},
            {"name": "Camiseta Amor de Cristo", "price": "R$ 79,99", "original_price": "R$ 79,99", "discount": "10% OFF", "image": "img/img10.png"},
            {"name": "Camiseta Louvando a Deus", "price": "R$ 99,99", "original_price": "R$ 99,99", "discount": "30% OFF", "image": "img/img11.png"},
            {"name": "Camiseta Jesus & Cruz", "price": "R$ 59,99", "original_price": "R$ 59,99", "discount": "8% OFF", "image": "img/img12.png"},
        ]
    ...
    def open_admin_window(self):
        def login():
            ...
            # Credenciais de administrador (exemplo)
        ...
        admin_window.title("Área Administrativa")
        admin_window.geometry("400x300")

        tk.Label(admin_window, text="Usuário", font=("Arial", 12)).pack(pady=5)
        username_entry = tk.Entry(admin_window, font=("Arial", 12))
        username_entry.pack(pady=5)

        tk.Label(admin_window, text="Senha", font=("Arial", 12)).pack(pady=5)
        password_entry = tk.Entry(admin_window, font=("Arial", 12), show="*")
        password_entry.pack(pady=5)

        tk.Button(admin_window, text="Entrar", bg="green", fg="white", font=("Arial", 12), command=login).pack(pady=10)
